...
if __name__ == "__main__":
	...
	INFO=info
	PAS=pasfile
	INP="scan/%s.%s.peak.%d.%d.txt"%(testid,baseName,threshold,penality)
	OUT="map/%s.%s.peak.%d.%d.txt"%(testid,baseName,threshold,penality)
	STAT="Stat/%s.%s.peak.%d.%d.txt"%(testid,baseName,threshold,penality)
