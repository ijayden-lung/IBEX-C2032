...
spe='hg38'
PAS="usage_data/snu398_control.pAs.usage.txt"
scanTranscriptom="/home/longy/project/Split_BL6/snu398_control_data/chr7_+_0"
baseName=${scanTranscriptom##*/}
pos_file="data/positive/snu398_control_aug12_SC_p1r0.05u0.05/$baseName"
neg_file="data/negative/snu398_control_aug12_SC_p1r0.05u0.05_0/$baseName"
neg_file2="data/positive/neg2.$baseName"
Shift=12
model="bestModel/snu398_control.pAs.single_kermax6.snu398_control_aug12_SC_p1r0.05u0.05_4-0234.ckpt"
polyASeqRCThreshold=1
RNASeqRCThreshold=0.05
usageThreshold=0.05
prob=0.001
pre_file="maxSum/snu398_control.pAs.single_kermax6.snu398_control_aug${Shift}_SC_p1r0.05u0.05_0-0234.${baseName}.txt.bidirection.12.1.txt"
...
#python change_all.py --std_inp="47432133" --scan="../Split_BL6/snu398_control_data/chr1_-_5" --output="test" 
