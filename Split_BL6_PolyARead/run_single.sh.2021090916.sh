...
spe='hg38'
Shift=12
bestEpoch=0060 #288 162 279 17 60
round=4
learning_rate=6e-4 #####small learning rate for fine tuning
task='evaluation' ##tak = [preparation trainin evaluation statistics]
#K562 371 156 53 98 18 #S 321 30 209 102 12 #C 486 80 357 20
#HepG2 202 123 24 30 10 #S 297 64 9 441 403 #C 288 428 286 241
