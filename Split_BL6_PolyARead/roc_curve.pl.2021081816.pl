...
open OUT,">Figures/thle2/predicted5.txt";
print OUT "# number of gournd truth pas: 20258\n";
print OUT "predict_pasid\tgt_pasid\tgt_diff\tdb_pasid\tdb_diff\tscore\n";
for my $file (glob "maxSum/thle2_control.pAs.single_kermax6.thle2_control_aug12_SC_p1r0.05u0.05_5-0014.*.txt.bidirection.0.1.txt"){
