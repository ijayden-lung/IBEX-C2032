...
=cut
#=pod
my $COV = "HUH7_Control.pAs.coverage.txt";
my $COV2 = "HUH7_Control.pAs.gen.coverage.txt";
#my $usage = "/home/longy/project/Split_BL6/polyA_seq/HUH7_Control.pAs.usage.txt";
#my $out = "HUH7_Control.pAs.old.usage.txt";
my $usage = "HUH7_Control.pAs.old.usage.txt";
my $out  = "test";
