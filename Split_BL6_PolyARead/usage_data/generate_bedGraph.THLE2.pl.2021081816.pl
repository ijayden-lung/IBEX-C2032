...
my $score_file = "../predict/THLE2_Control.pAs.single_kermax6.THLE2_Control_aug12_SC_p1r0.05u0.05_4-0006.$chr\_$strand\_$block.txt";
...
my $times = 8.9;
open OUT,">../Figures/THLE2/THLE2.MKLN1.bedGraph";
