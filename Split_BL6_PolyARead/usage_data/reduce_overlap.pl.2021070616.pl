...
=cut
#=pod
my $usage = "/home/longy/project/Split_BL6/polyA_seq/human_liver.pAs.usage.txt";
my $out = "human_liver.pAs.usage.txt";
my $db = "/home/longy/workspace/apa_predict/pas_dataset/hg38.pAs.tianbin.txt";
my $COV = "human_liver.pAs.merge.coverage.txt";
#my $COV2 = "human_liver.pAs.ens.coverage.txt";
#my $COV3 = "human_liver.pAs.coverage.all.txt";
#=cut
