...
sub cell_line{
	...
	if($cell eq "SNU398"){
		my $times = 7.8;
		my $rep = "SNU398_Control";
		my $score_base = "../predict/snu398_control.pAs.single_kermax6.snu398_control_aug12_SC_p1r0.05u0.05_4-0038";
	}
	elsif($cell eq "THLE2"){
		my $times = 8.9;
		my $rep = "THLE2_Control";
		my $score_base = "../predict/thle2_control.pAs.single_kermax6.thle2_control_aug12_SC_p1r0.05u0.05_4-0010";
	}
	elsif($cell eq "HepG2"){
		my $times = 6.2;
		my $rep = "HepG2_Control";
		my $score_base = "../predict/HepG2_Control.pAs.single_kermax6.HepG2_Control_aug12_SC_p1r0.05u0.05_4-0010";
	}
	elsif($cell eq "K562"){
		my $times = 33.3;
		my $rep = "K562_Chen";
		my $score_base = "../predict/K562_Chen.pAs.single_kermax6.K562_Chen_aug12_SC_p3.5r0.05u0.05_4-0018";
	}
	...
	&main("anno",$block_dir,$anno_base);
	&main("score",$block_dir,$score_base);
	&main("cov",$block_dir,undef);
	&main("pol",$block_dir,$pol_base);
	&main("pos",$block_dir,$pos_base);
}
sub main{
	my ($action,$block_dir,$base) = @_;
	my $count = 0;
