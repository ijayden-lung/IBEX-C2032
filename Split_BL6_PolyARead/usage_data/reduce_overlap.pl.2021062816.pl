...
=cut
#=pod
my $usage = "../../Split_BL6/polyA_seq/HUH7_Control.pAs.usage.txt";
my $out = "HUH7_Control.pAs.usage.txt";
my $db = "/home/longy/workspace/apa_predict/pas_dataset/hg38.pAs.tianbin.txt";
my $COV = "HUH7_Control.pAs.merge.coverage.txt";
#=cut
=pod
my $usage = "/home/longy/project/Split_BL6/polyA_seq/K562_Chen.pAs.usage.txt";
#my $usage = "/home/longy/project/Split_BL6/polyA_seq/usage.K562.pAs.txt";
my $out = "K562_Chen.pAs.usage.txt";
my $db = "/home/longy/workspace/apa_predict/pas_dataset/hg38.pAs.tianbin.txt";
my $COV = "K562_Chen.pAs.merge.coverage.txt";
#my $COV2 = "K562_Chen.pAs.ens.coverage.txt";
#my $COV3 = "K562_Chen.pAs.coverage.all.txt";
=cut
