...
spe='hg38'
Shift=12
polyASeqRCThreshold=18
usageThreshold=0.05
bestEpoch=0109 #18 109

#9 251 169 97 1 8 #1 130 38 65 10 6#3 200 140 83 43 3#5 263 202 21 19 81#small9 226 153 6 127 7#9 433 135 91 46 30
...
round=0
learning_rate=10e-4 #####small learning rate for fine tuning
