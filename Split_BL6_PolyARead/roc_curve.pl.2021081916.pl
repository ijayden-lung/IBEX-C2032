...
open OUT,">Figures/HepG2/predicted.txt";
print OUT "# number of gournd truth pas: 20990\n";
print OUT "predict_pasid\tgt_pasid\tgt_diff\tdb_pasid\tdb_diff\tscore\n";
for my $file (glob "maxSum/HepG2_Control.pAs.single_kermax6.HepG2_Control_aug12_SC_p1r0.05u0.05_4-0010.*.txt.bidirection.0.1.txt"){
