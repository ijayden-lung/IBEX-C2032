...
my ($PAS,$file,$round,$polyASeqRCThreshold,$RNASeqRCThreshold,$usageThreshold,$prob,$Shift) = @ARGV;
print "randomly select negative datasets\n";
print "$PAS,$file,$round,$polyASeqRCThreshold,$RNASeqRCThreshold,$usageThreshold,$prob,$Shift\n";
my $Threshold  = 50;
