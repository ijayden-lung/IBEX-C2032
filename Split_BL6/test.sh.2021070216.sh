...
python extract_coverage_from_scanGenome.py --pas_file="/home/longy/cnda/ensembl/Homo_sapiens.GRCh38.103.gtf.gz" --scan_file="test_data/chr11_+_0" --file_type="ensembl"
