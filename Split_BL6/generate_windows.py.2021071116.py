...
def split(root_dir,Fixed_length,input_file,ens_file,reference,window):
    ...
    for i, line in enumerate(lines):
        ...
        if(count>len_blocks and pos-pre_pos>1000 and save_block<num_blocks-1):
            ...
            if(index1%2==1 and index2%2==0):
                write_file(info,dict_line,chromosome,strand,save_block,start,pre_pos,count,reference,window)
                count = 0
                save_block += 1
                start  = pos
...
if __name__ == "__main__":
    ...
    split(root_dir,Fixed_length,input_file,ens_file,reference,window)
