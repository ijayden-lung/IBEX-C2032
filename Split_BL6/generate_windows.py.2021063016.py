...
def split(root_dir,Fixed_length,input_file,gene_position_array,reference,chromosome,sttrand):
    ...
    for i, line in enumerate(lines):
        ...
        if(count>len_blocks and pos-pre_pos>1000 and save_block<num_blocks-1):
            ...
            if(index1%2==1 and index2%2==0):
                ...
                for pos,rpm in dict_line.items():
                    ww.write('%s:%d:%s\t%s\n'%(chromosome,pos,strand,rpm))
                ww.close()
                dict_line.clear()
                count = 0
                save_block += 1
...
if __name__ == "__main__":
    ...
    split(root_dir,Fixed_length,input_file,gene_position_array,reference,chromosome,strand)
