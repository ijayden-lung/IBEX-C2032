...
coverage="../../Split_BL6_PolyARead/usage_data/SNU398_Control.pAs.merge.coverage.txt"
target="SNU398_Control.pAs.bed"
new="SNU398_Control.pAs.usage.txt"
#target="SNU398_Control.${testid}.pAs.bed"
#new="SNU398_Control.pAs.${testid}.usage.txt"
bam1="/home/longy/project/HepG2/SNU398_1.bam"
bam2="/home/longy/project/HepG2/SNU398_2.bam"
mod1="modSNU398_1.bed"
mod2="modSNU398_2.bed"
#BL
:<<BL
ENS="/home/longy/cnda/ensembl/Homo_sapiens.GRCh38.103.gtf.gz"
