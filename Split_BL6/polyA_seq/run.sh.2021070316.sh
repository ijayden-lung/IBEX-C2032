...
coverage="../../Split_BL6_PolyARead/usage_data/huh7_control.pAs.merge.coverage.txt"
target="huh7_control.pAs.bed"
new="huh7_control.pAs.usage.txt"
#target="huh7_control.${testid}.pAs.bed"
#new="huh7_control.pAs.${testid}.usage.txt"
bam1="/home/longy/project/HepG2/HUH7_1.bam"
bam2="/home/longy/project/HepG2/HUH7_2.bam"
mod1="modHUH7_1.bed"
mod2="modHUH7_2.bed"
#BL
:<<BL
