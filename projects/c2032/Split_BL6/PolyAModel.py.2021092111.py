...
def CNN(inputs,filter_size,pool_size):
	...
	x = Conv1D(filters= 32, kernel_size= filter_size, padding = 'valid', kernel_regularizer = regularizers.l2(1e-4), bias_regularizer = regularizers.l2(1e-4))(inputs)
...
def PolyA_CNN(combination,length):
