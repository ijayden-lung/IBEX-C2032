...
#samtools view -b -f 128 -F 16 chr21.unique.bam > a.fwd1.bam
#samtools view -b -f 80 chr21.unique.bam > a.fwd2.bam
...
#samtools view -b -f 144 chr21.unique.bam > a.rev1.bam
#samtools view -b -f 64 -F 16 chr21.unique.bam > a.rev2.bam
