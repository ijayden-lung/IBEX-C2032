...
coverage="../../Split_BL6_PolyARead/usage_data/k562_control.pAs.merge.coverage.txt"
...
bam1="k562_control1Aligned.out.bam"
bam2="k562_control1Aligned.out.bam"
mod1="modk562_control_1.bed"
mod2="modk562_control_2.bed"
#BL
:<<BL
ENS="/home/longy/cnda/ensembl/Homo_sapiens.GRCh38.103.gtf.gz"
