...
coverage="../../Split_BL6_PolyARead/usage_data/SNU398_Control.pAs.gen.coverage.txt"
target="SNU398_Control.pAs.bed"
new="SNU398_Control.pAs.gen.usage.txt"

#coverage="../../Split_BL6_PolyARead/coverage_data/Finetune_k562Tothle2.thle2_chen.coverage.txt"
#target="Finetune.thle2.pAs.bed"
#new="Finetune.thle2.usage.txt"
bam1="SNU398_ControlAligned.out.bam"
bam2="SNU398_ControlAligned.out.bam"
