...
coverage="../../Split_BL6_PolyARead/usage_data/HepG2_Control.pAs.gen.coverage.txt"
target="HepG2_Control.pAs.bed"
new="HepG2_Control.pAs.gen.usage.txt"
...
bam1="HepG2_ControlAligned.out.bam"
bam2="HepG2_ControlAligned.out.bam"
mod1="modHepG2_3.bed"
mod2="modHepG2_4.bed"
#BL
:<<BL
