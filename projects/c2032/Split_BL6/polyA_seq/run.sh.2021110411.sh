...
coverage="../../Split_BL6_PolyARead/usage_data/THLE2_Control.pAs.gen.coverage.txt"
target="THLE2_Control.pAs.bed"
new="THLE2_Control.pAs.gen.usage.txt"
...
bam1="THLE2_ControlAligned.out.bam"
bam2="THLE2_ControlAligned.out.bam"
mod1="modTHLE2_1.bed"
mod2="modTHLE2_2.bed"
#BL
:<<BL
