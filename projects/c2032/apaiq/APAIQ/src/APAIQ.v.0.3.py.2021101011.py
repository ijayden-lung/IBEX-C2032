...
if __name__ == '__main__':
    ...
    for i in range(2):
        ...
        for chromosome,strand,block_num,start,end in blocks:
            ...
            block_input_list.append([baseName,model,out_dir,rst,window,keep_temp,threshold,penality,DB_file,input_file,fa_file,chromosome,strand,depth,start,end])
        ...
        #requests = threadpool.makeRequests(run_single_block,block_input_list)
        #[pool.requests(req) for req in requests]
        #pool.wait()
