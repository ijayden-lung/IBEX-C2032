...
WIG="../Split_BL6/STAR/K562_Chen/Signal.Unique.${strand}.out.${chr}.wig"
thre=3.5
python change_gt.py  --scan_file=$WIG --pre_file='usage_data/K562_Chen.pAs.usage.txt'  --output="results/${chr}.${strand}" --chromosome=$chr --strand=$sign --thre=$thre
