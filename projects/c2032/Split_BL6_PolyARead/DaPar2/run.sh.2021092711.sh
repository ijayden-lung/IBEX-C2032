...
PAS="../usage_data/${cell}_Chen.pAs.usage.txt"
DB="../usage_data/${cell}_Chen.pAs.coverage.txt"
...
perl postprocess.bidirection.pl $PAS $DB ${cell}.pAs.coverage.txt $OUT 3.5 0.05 0.05
