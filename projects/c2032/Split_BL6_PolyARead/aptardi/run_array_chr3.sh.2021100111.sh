...
SAMPLE="K562"
BAM="/home/longy/project/Split_BL6/STAR/${SAMPLE}_Chen/Aligned.sortedByCoord.out.bam"
...
OUT="../Figures/${SAMPLE}/predicted.aptardi.txt"
...
input="output_dir/${SAMPLE}_aptardi.gtf"
perl postprocess.bidirection.pl  $PAS $DB $input $OUT 3.5 0.05 0.05
