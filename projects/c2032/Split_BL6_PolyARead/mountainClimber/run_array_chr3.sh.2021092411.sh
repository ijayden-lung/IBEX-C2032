...
DB="../usage_data/${SAMPLE}_Chen.pAs.coverage.txt"
...
python ./src/mountainClimberCP.py -i ./bedgraph/$SAMPLE.$chr."+".bedgraph -m ./bedgraph/$SAMPLE.$chr."-".bedgraph -g tus_merged/$SAMPLE.annot.${chr}_singleGenes.bed  -j ./junctions/$SAMPLE.$chr.bed -o mountainClimberCP/$SAMPLE.$chr.bed -x $FA 
BL

perl postprocess.bidirection.pl $PAS $DB mountainClimberCP/${SAMPLE}.all.bed $OUT 1 0.05 0.05
