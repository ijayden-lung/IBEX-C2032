...
my %hash_readcount;
&get_polyAread("../../Split_BL6/polyA_seq/THLE2_Control.pAs.merge.usage.txt",'THLE2');
&get_polyAread("../../Split_BL6/polyA_seq/K562_Chen.pAs.merge.usage.txt",'K562');
&get_polyAread("../../Split_BL6/polyA_seq/SNU398_Control.pAs.merge.usage.txt",'SNU398');
&get_polyAread("../../Split_BL6/polyA_seq/HepG2_Control.pAs.merge.usage.txt",'HepG2');
