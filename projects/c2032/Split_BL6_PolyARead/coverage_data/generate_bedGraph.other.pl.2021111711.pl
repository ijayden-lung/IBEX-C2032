...
my %gene = ("NAXE"=>['chr1','+',156592671,156604299],

			);
&cell_line("K562","other");
sub cell_line{
	my ($cell,$type) = @_;
	my $rep;
	my $times  = 33.3;
	...
	my $pos_base3 = "../Figures/$cell/predicted.Dapars2.txt";
	...
	my $pos_base5 = "../Figures/K562/predicted.aptardi.txt";
