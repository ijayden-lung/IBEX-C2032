...
=cut
#=pod
my $COV = "k562_control.pAs.coverage.txt";
my $COV2 = "k562_control.pAs.merge.coverage.txt";
#my $usage = "/home/longy/project/Split_BL6/polyA_seq/k562_control.pAs.usage.txt";
#my $out = "k562_control.pAs.old.usage.txt";
my $usage = "k562_control.pAs.old.usage.txt";
my $out  = "k562_control.pAs.usage.txt";
