...
=cut
#=pod
my $COV = "SNU398_Control.pAs.coverage.txt";
my $COV2 = "SNU398_Control.pAs.gen.coverage.txt";
my $usage = "/home/longy/project/Split_BL6/polyA_seq/SNU398_Control.pAs.usage.txt";
#my $out = "SNU398_Control.pAs.old.usage.txt";
#my $usage = "SNU398_Control.pAs.old.usage.txt";
