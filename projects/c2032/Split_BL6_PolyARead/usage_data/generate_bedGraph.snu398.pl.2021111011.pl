...
use ReadFile;
my %gene = (
	#"B3GLCT"=>['chr13','+',31329987,31332276],
	#"ELP5:Intronic"=>['chr17','+',7254913,7260172], ###Intronic
	#"GPX3-UA:Upstream-antisense"=>['chr5','-',151018798,151020798],##UA
	#"SLC35F3"=>['chr1','+',234308246,234310246],##Exonic, some without RNA-Seq
	#"CSKMT Exonic"=>['chr11','+',62665574,62667071],##Exonic
	"RAB39A Extend"=>['chr11','+',107963056,107968162],##Extend
			);
&cell_line("SNU398");
&cell_line("THLE2");
&cell_line("HepG2");
...
sub cell_line{
	...
	open OUT,">../Figures/$cell/$cell.example.pending.bedGraph";
	my @genes = keys %gene;
