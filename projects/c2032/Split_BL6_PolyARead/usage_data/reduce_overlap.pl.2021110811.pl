...
my $COV2 = "HepG2_Control.pAs.gen.coverage.txt";
my $usage = "/home/longy/project/Split_BL6/polyA_seq/HepG2_Control.pAs.usage.txt";
#my $out = "HepG2_Control.pAs.old.usage.txt";
#my $usage = "HepG2_Control.pAs.old.usage.txt";
