...
#qapa build --db examples/hg38/ensembl.identifiers.txt -o gencode.polyA_sites.bed  gencode.basic.txt  >output_utrs.bed
qapa build --db examples/hg38/ensembl.identifiers.txt -o examples/hg38/SNU398.polyA_sites.bed examples/hg38/hg38_genes.genePred
