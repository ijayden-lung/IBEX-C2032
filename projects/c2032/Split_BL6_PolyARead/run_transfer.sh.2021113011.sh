...
if [ "$old" == "huh7" ]; then
	...
	oldmodel="bestModel/K562_Chen.pAs.single_kermax6.K562_Chen_aug12_SC_p3.5r0.05u0.05_4-0018.ckpt"
elif [ "$old" == "hepg2" ]; then
	...
	oldmodel="bestModel/bl6_rep1.pAs.single_kermax6.bl6_rep1_aug12_SC_p3.5r0.05u0.05_4-0001.ckpt"
elif [ "$old" == "kh" ]; then
