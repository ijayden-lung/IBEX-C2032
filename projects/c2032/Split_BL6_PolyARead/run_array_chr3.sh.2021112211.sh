...
WIG="../Split_BL6/STAR/SNU398_Control/Signal.Unique.${strand}.out.${chr}.wig"
python change_gt.py  --scan_file=$WIG --pre_file='../Split_BL6/polyA_seq/SNU398_Control.pAs.db.usage.txt'  --output="results/${chr}.${strand}" --chromosome=$chr --strand=$sign
