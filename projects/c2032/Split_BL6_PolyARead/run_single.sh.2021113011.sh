...
window=201
combination='C' ####combination = [SCP SC SP CP S C P]
epochs=500
maxPoint=12
penality=1
...
spe='hg38'
Shift=12
bestEpoch=0014 #405 254 222 14 1
round=0
learning_rate=10e-4 #####small learning rate for fine tuning
task='training' ##tak = [preparation training evaluation statistics]
#298
#bl6 #405 254 222 14 1
#K562 371 156 53 98 18 #S 321 30 209 102 12 #C 486 316 182* 236 12
#HepG2 202 123 24 30 10 #S 297 64 9 441 403 #C 288 162 279 17 60
#snu398 234 126 29 48 38 #S 181 106 49 95 5 #C 491 103 256 356 376
#thle2 109 168 21 251 10 #S 341 92 54 72 2 #C 484 167 414 29 13
...
if [ "$cell" == "HepG2" ]; then
	...
	ENS='/home/longy/cnda/gencode/gencode.vM25.primary_assembly.annotation.gtf'
	sample="bl6_rep1"
	block_num=212
	polyASeqRCThreshold=3.5
	RNASeqRCThreshold=0.05
...
#model="bestModel/K562_Chen.pAs.single_kermax6.K562_Chen_aug12_SC_p3.5r0.05u0.05_4-0018.ckpt"
###########IMPORTANT FILE PATH
###########################################################################
