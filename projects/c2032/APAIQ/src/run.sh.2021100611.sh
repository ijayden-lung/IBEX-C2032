...
time python -u APAIQ.v.0.3.py   --input_file='../demo/RNAseq.depth.bedGraph' --fa_file='/home/longy/project/apaiq/oneLine/hg38' --model '/home/longy/project/apaiq/APAIQ/model/snu398_model.ckpt'  --DB_file='/home/longy/project/apaiq/demo/polyADB3_gencode.pAs.txt'  --name='chr'
