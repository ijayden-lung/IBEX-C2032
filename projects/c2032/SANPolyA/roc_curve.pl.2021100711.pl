...
my $com = "SANPolyA";
open OUT,">../Split_BL6_PolyARead/Figures/$cell/predicted.$com.txt";
print OUT "# number of gournd truth pas: $gt_num\n";
print OUT "predict_pasid\tgt_pasid\tgt_diff\tdb_pasid\tdb_diff\tscore\n";
for my $file (glob "maxSum/$cell\_Chen.pAs.single_kermax6.$cell\_Chen_aug12_$combination\_p3.5r0.05u0.05_3-$bestEpoch.*.txt.bidirection.0.1.txt"){
#for my $file (glob "maxSum/K562_Chen.pAs.single_kermax6.K562_Chen_aug12_S_p3.5r0.05u0.05_3-0008.chr*bi*"){
