...
if __name__ == "__main__":
	...
	train_data,train_labels = prep_data(ROOT_DIR,BLOCK_DIR,polyA_file,ROUNDNAME,NUM_FOLDS,'train',length)
	valid_data,valid_labels = prep_data(ROOT_DIR,BLOCK_DIR,polyA_file,ROUNDNAME,NUM_FOLDS,'valid',length)
	...
	model.compile(loss='binary_crossentropy', optimizer= SGD(momentum = 0.95, learning_rate = 0.005,nesterov=True), metrics=[binary_accuracy])
